...
| Bower | Bower is used to install our client-side dependencies like jQuery and D3.js. Once you have Bower installed run: ``` $ cd diversityDesert && bower install ``` | http://bower.io/ |
